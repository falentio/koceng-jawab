...
async function getQuestions(subject: keyof typeof subjects, student: number, userAgent = defaultUserAgent()) {
  ...
  const req = new Request("https://script.google.com/macros/s/AKfycby1LQUD6BfG4lDkTgZgbnkCJXgyBHe8-h3JwCQvLoIb3YHeRv7MuIBmOpeIxi4z4muHNw/callback?nocache_id=5", {
    "headers": {
      "accept": "*/*",
