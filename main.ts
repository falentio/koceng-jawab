...
const endpoint = () => `https://script.google.com/macros/s/AKfycby1LQUD6BfG4lDkTgZgbnkCJXgyBHe8-h3JwCQvLoIb3YHeRv7MuIBmOpeIxi4z4muHNw/callback?nocache_id=${Math.random() * 500 | 0}`
...
async function getQuestions(subject: keyof typeof subjects, student: number, userAgent = defaultUserAgent()) {
	...
	const res = await fetch("https://script.google.com/macros/s/AKfycby1LQUD6BfG4lDkTgZgbnkCJXgyBHe8-h3JwCQvLoIb3YHeRv7MuIBmOpeIxi4z4muHNw/callback?nocache_id=5", {
		"headers": {
			"accept": "*/*",
